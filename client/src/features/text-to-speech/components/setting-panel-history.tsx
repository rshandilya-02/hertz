    ...
    return (
        <div className="flex h-full flex-col items-center justify-center gap-2 p-8">
            <div className="relative flex w-25 items-center justify-center">
                ...
                <div className="relative z-10 bg-foreground rounded-full p-3">
                    <AudioWaveform className="size-4 text-background"></AudioWaveform>
                </div>

                <div className="absolute right-0 rotate-30 rounded-full bg-muted p-3">
                    <Clock className="size-4 text-muted-foreground"></Clock>
                </div>
            </div>
